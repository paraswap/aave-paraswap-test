...
async function main() {
  ...
  const priceRoute = await paraswap.getRate(WETH[FORK_NETWORK_ID], DAI[FORK_NETWORK_ID], amount_to_swap.toString(), signer.address, 'SELL', { partner: 'aave', includeContractMethods: ['multiSwap'] });
